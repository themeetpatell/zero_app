...
const sections = [
  {
    title: 'Product',
    links: [
      { label: 'Our Tools', href: '/product', showSoon: true },
      { label: 'API', href: '/api', showSoon: true },
      { label: 'Zero V1', href: '/research/introducing-zero-v1', showSoon: false },
      { label: 'Zero Co-Director', href: '/research/zero-co-director', showSoon: false },
      { label: 'Use Cases', href: '/product#use-cases', showSoon: true },
      { label: 'Ways to Use Zero Human', href: '/product#use-cases', showSoon: true },
    ],
  },
  {
    title: 'Company',
    links: [
      { label: 'Our Research', href: '/research', showSoon: true },
      { label: 'Publications', href: '/research', showSoon: true },
      { label: 'Careers', href: '/careers', showSoon: true },
      { label: 'About Us', href: '/about', showSoon: true },
      { label: 'Customer Stories', href: '/stories', showSoon: true },
  ...
  },
  {
    title: 'Get Started',
    links: [
      { label: 'For Enterprises', href: '/sales', showSoon: true },
      { label: 'For Education', href: '/education', showSoon: true },
      { label: 'Login', href: '/signin', showSoon: false },
      { label: 'Pricing', href: '/pricing', showSoon: false },
      { label: 'Help Center >', href: '/help', showSoon: true },
