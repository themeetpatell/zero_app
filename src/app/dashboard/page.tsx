...
export default function Home() {
  ...
  // Handle input focus from CommunityExplore tab - transition to conversation mode
    ...
    const handleEsc = (e: KeyboardEvent) => {
      if (e.key === "Escape") {
        if (showCanvas) {
          ...
          // If in conversation, return to explore
          setIsConversationMode(false);
  ...
  return (
    <div className="flex h-dvh w-full overflow-hidden bg-bg-underlay">
      ...
      <div className="flex-1 relative overflow-hidden">
        ...
        {/* HOME/CREATIONS MODE - generation box centered, no partition */}
        {!isConversationMode && !showCanvas && (
          <div className="relative w-full h-full">
            <CommunityExplore onInputFocus={handleInputFocus} />
